      ...
      <div className='z-5 lg:peer-focus/btn:ml-[200px] lg:peer-focus/drawer:ml-[200px] flex-grow'>
        ...
        <div className=' block lg:hidden w-full '>
          <fieldset>
            ...
            <input type='radio' id='tab1' className='peer/tab1  opacity-0 absolute left-20' name='tabs' />
            <label htmlFor='tab1' id='discussion'>
              <p className={`bg-blue-950 text-center peer-checked/discussion:text-blue-200 text-white text-lg w-1/2 h-10 pt-2 inline-block`}>Discussion Forum</p>
            </label>
            <input type='radio' id='tab2' className='peer/tab2  opacity-0 absolute left-20' name='tabs' />
            <label htmlFor='tab2'>
            ...
            <div className=' peer-checked/tab1:block peer-checked/tab2:hidden mt-10'>
              <DiscussionForum></DiscussionForum>
            </div>
            <div className='peer-checked/tab1:hidden peer-checked/tab2:block mt-10'>
              <MarketStories></MarketStories>
            </div>
          </fieldset>
        </div>
